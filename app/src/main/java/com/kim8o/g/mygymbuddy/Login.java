...
//If the user enters a username and password
    ...
    public void onUserLogin(View view) {
        EditText msgViewUser = (EditText) findViewById(R.id.etxt_username);
        String msgTextUser = msgViewUser.getText().toString();
        EditText msgViewPass = (EditText) findViewById(R.id.etxt_password);
        String msgTextPasswd = msgViewPass.getText().toString();
        Intent intent = new Intent(this, DailyUpdate.class);
        intent.putExtra(User.EXTRA_MESSAGE, msgTextUser);
        EditTxtUserName = (EditText) findViewById(R.id.etxt_username);

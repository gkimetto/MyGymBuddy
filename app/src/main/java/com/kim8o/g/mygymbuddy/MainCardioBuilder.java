...
/**
 * Created by gkimetto on 11/21/2015.
 */




public class MainCardioBuilder extends Activity implements CardioPlanBldrListFragment.CardioPlanListListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_activity_cardio);
    ...
    public void itemClicked(long id){
        ...
        View fragmentContainer =findViewById(R.id.frag_cont_cardio_plan_bldr);
        if (fragmentContainer!=null) {
            //This is defined in the listener
            CardioPlanDetailFragment details = new CardioPlanDetailFragment();
            //Start the fragment transaction
            FragmentTransaction ft = getFragmentManager().beginTransaction();
            details.setCardioPlan(id);
            //Reglace the fragment and add it to the back stack
            ft.replace(R.id.frag_cont_cardio_plan_bldr, details);
